...
export class SimpleMesh {
    ...
    name;
    constructor(topo, indices, positions, colors, name) {
...
export class Sample10 {
    ...
    triangleStripPipeline;
    zBuffer;
    format;
    lastUpdate = performance.now();
    constructor(device, context, meshData) {
        this.device = device;
