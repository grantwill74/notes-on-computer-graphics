...
The resulting waves will be perceived the same by someone with typically functioning eyes, but will have completely different mathematical functions.#footnote[in fact, they will also reflect differently on non-white surfaces]
...
But wait, how do displays even work?

== The different kinds of display
